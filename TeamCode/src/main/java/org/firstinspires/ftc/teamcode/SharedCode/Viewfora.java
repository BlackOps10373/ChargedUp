...
public class Viewfora {
    ...
    boolean useViewforia = true;
        ...
        Viewfora(Telemetry _telemetry, HardwareMap hardwareMap, DriveTrain.Alliance _alliance) {
            ...
            final float CAMERA_FORWARD_DISPLACEMENT = 6.9f * mmPerInch;   // eg: Enter the forward distance from the center of the robot to the camera lens
            final float CAMERA_VERTICAL_DISPLACEMENT = 5.75f * mmPerInch;   // eg: Camera is 6 Inches above ground
            final float CAMERA_LEFT_DISPLACEMENT = 0 * mmPerInch;   // eg: Enter the left distance from the center of the robot to the camera lens
            ...
            public boolean updatePosition(Vector2D retPosition, refDouble retRotation) {
                boolean ret = false;
                ...
                VuforiaTrackable trackingTrackable = null;
                targetVisible = false;
                    for (VuforiaTrackable trackable : allTrackables) {
                        if (((VuforiaTrackableDefaultListener) trackable.getListener()).isVisible()) {
                            //telemetry.addData("Visible Target", trackable.getName());
                            targetVisible = true;
                            trackingTrackable = trackable;
                            ...
                            if (robotLocationTransform != null) {
                                ret = true; // mark that the position updated
                ...
                if (targetVisible) {
                    ...
                    telemetry.addData("Tracking", trackingTrackable.getName());
                    int sign = 1;
